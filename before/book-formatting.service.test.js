...
describe('BookFormattingService', () => {
    ...
    const bookFormattingService = new BookFormattingService();
...
`;
        const booksCSV = await bookFormattingService.getCSVFormattedBooks();
    ...
    it('getBooksJSON should return list of books in JSON format', async () => {
        ...
        const booksJSON = await bookFormattingService.getJSONFormattedBooks();
